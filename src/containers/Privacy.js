...
function Privacy(props) {
    return <html>
        <head>
            ...
            <title>Feriapp - Privacy Policy</title>
            <meta name="viewport" content="width=device-width, initial-scale=1" />
        </head>
        <body>
            <h1>Feriapp Privacy Policy</h1>
            <h3>Owner</h3>
            <p>The app is developed by Feriapp team, you can  contact us via web form at <a target="_blank" rel="noopener noreferrer" href="https://forms.gle/fT73PRvhUcz5iGv27">this page</a>.</p>
    ...
    <ul><li>send to the user the beta version off the app</li>
            ...
            <ul><li>Withdraw their consent at any time. Users have the right to withdraw consent where they have previously given their consent to the processing of their Personal Data.</li>
