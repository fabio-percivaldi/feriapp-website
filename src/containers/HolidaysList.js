...
const renderHoliday = (holiday, index) => {
    const { caption, media_url, permalink } = holiday
    return <a style={{cursor: 'pointer', width: '15%', height: '300px', marginBottom: 'auto', marginTop: 'auto'}} href={permalink} rel="noopener noreferrer" target="_blank">
        <Card className='grow' key={index} style={{ height: '100%', boxShadow: '0 2px 4px 0 rgba(0, 0, 0, 0.2), 0 3px 10px 0 rgba(0, 0, 0, 0.19)', borderRadius: '7px' }}>
